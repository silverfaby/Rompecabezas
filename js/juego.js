...
var instruccion1 = "Utiliza las flechas para mover las piezas";
var instruccion2 = "Ordena las piezas hasta alcanzar la imagen objetivo";
var instrucciones = [instruccion1, instruccion2];
...
function chequearSiGano() {
    ...
    for (var i = 0; i < grilla.length; i++) {
      for (var n = 0; n < nuevaGrilla.length; n++) {
        if(grilla[i][n] != nuevaGrilla[i][n]){
          return false;
        }
      }
    }
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
    //COMPLETAR
  var valTemp = grilla[filaPos1] [columnaPos1];

  grilla[filaPos1] [columnaPos1] = grilla[filaPos2] [columnaPos2];
  grilla[filaPos2] [columnaPos2] = valTemp;
  // 
